"""
This script is called by the plugin-wrapper, PythonPlug.js, which passes down the
...
from PythonPlug import PythonPlug
...
plugin = PythonPlug(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
